...
export const PREMIUM_WEAPONS: PremiumWeapon[] = [
  ...
  {
    id: 'apxh3', name: 'APX-H3 INFERNO', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0xff7a2a,
    philosophy: 'A thermobaric siege launcher: twin fuel-air reservoirs feed a wide combustion throat through a spinning injector.',
    blurb: 'It does not explode. It ignites the air itself.',
    stats: { power: 700, rate: 2.4, mag: 3, reload: 4.0 },
    battlefieldEvent: 'THERMOBARIC FIRESTORM — a rolling wall of pressure-fed fire that scorches the zone and lingers.',
    locked: true,
  },
  {
    id: 'apxh4', name: 'APX-H4 GLACIER', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0x8ff0ff,
    philosophy: 'A cryogenic siege platform: a rotating condenser super-cools the charge that flash-freezes the impact zone.',
    blurb: 'Control by absolute cold. The battlefield simply stops moving.',
    stats: { power: 450, rate: 2.0, mag: 4, reload: 3.8 },
    battlefieldEvent: 'CRYOGENIC ICE FIELD — flash-freezes the ground, slowing and shattering anything caught in it.',
    locked: true,
  },
  {
    id: 'apxh5', name: 'APX-H5 CONTAGION', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0x7dff9a,
    philosophy: 'A nanite dispersal cannon: a carousel of nanomachine pods vents a self-directing swarm through a dispersal aperture.',
    blurb: 'You do not aim it at a target. You aim it at an area, and the area dies.',
    stats: { power: 380, rate: 1.6, mag: 5, reload: 4.2 },
    battlefieldEvent: 'NANITE SWARM — a self-directing cloud of nanomachines that hunts and corrodes for several seconds.',
    locked: true,
  },
  {
    id: 'apxh6', name: 'APX-H6 SUNDER', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0xffc23a,
    philosophy: 'A shockwave projector: pressure accumulators discharge through a concussion dish — it fires force, not a shell.',
    blurb: 'No projectile. Just a wall of pressure that unmakes everything in its path.',
    stats: { power: 520, rate: 1.8, mag: 4, reload: 3.6 },
    battlefieldEvent: 'SHOCKWAVE RING — an expanding concussion ring that hurls back everything it passes through.',
    locked: true,
  },
  {
    id: 'apxh7', name: 'APX-H7 HELIOS', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0xf2f6ff,
    philosophy: 'A fusion cannon: an open containment lattice cradles a blazing fusion core focused down a hardened throat.',
    blurb: 'It fires a fragment of a star. Nothing was built to survive that.',
    stats: { power: 1100, rate: 3.6, mag: 2, reload: 4.8 },
    battlefieldEvent: 'FUSION STORM — a miniature star detonates, bathing the area in blistering radiant heat.',
    locked: true,
  },
  {
    id: 'apxh8', name: 'APX-H8 SALVO', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0xff5a5a,
    philosophy: 'Micro-missile artillery: a honeycomb of independently-targeted tubes saturates a zone under a rotating radar.',
    blurb: 'One trigger pull. Forty impacts. Nowhere to hide.',
    stats: { power: 90, rate: 0.3, mag: 24, reload: 4.0 },
    battlefieldEvent: 'SATURATION BARRAGE — a grid of micro-missiles rains across the target zone in overlapping blasts.',
    locked: true,
  },
  {
    id: 'apxh9', name: 'APX-H9 AUGER', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0xffa040,
    philosophy: 'A drill-missile launcher: a rotating penetrator bit burrows before detonating deep beneath cover.',
    blurb: 'Cover is not protection. It is just a longer way down.',
    stats: { power: 850, rate: 3.0, mag: 2, reload: 4.4 },
    battlefieldEvent: 'SEISMIC RUPTURE — the drill round burrows and detonates, tearing a fissure that swallows the ground.',
    locked: true,
  },
  {
    id: 'apxh10', name: 'APX-H10 NEMESIS', code: 'APX', tier: 'apex', category: 'heavy', type: 'Siege Platforms', accent: 0xc8ff3a,
    philosophy: 'A reactor-meltdown siege gun: exposed fuel rods vent an unstable core that seeds a radiation field.',
    blurb: 'The last resort. It poisons the very ground it fires upon.',
    stats: { power: 600, rate: 2.6, mag: 3, reload: 4.6 },
